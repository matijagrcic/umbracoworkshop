...
declare module umbraco.services {
    ...
    */
    interface IMediaPickerProperty {
        id: number;
        value: string;
        alias: string; //MediaPickerPropertyAlias[MediaPickerPropertyAlias.umbracoFile]
        editor: string;
    }

    /**
     * Media Picker Property Alias
    */
    enum MediaPickerPropertyAlias {
        umbracoFile,
        umbracoWidth,
        umbracoHeight,
        umbracoBytes,
    ...
    */
    ...
    /**
     * Media Thumbnail Style
    */
    interface IMediaThumbnailStyle {
     ...
     * Media Picker Model
    */
    interface IMediaPickerModel {
        properties: IMediaPickerProperty[];
        updateDate: Date;
        createDate: Date;
        published: boolean;
        owner: IMediaOwner;
        ...
        style: IMediaStyle;
        thumbStyle: IMediaThumbnailStyle;
    }

    /**
     * Link Picker Targets
    */
    enum LinkPickerTargets {
        _blank,
        _top,
        _parent
    }
     ...
     * Link Picker Model
    */
    export interface ILinkPickerModel {
        id: number;
        name: string;
        url: string;
        target: string; // LinkPickerTargets[LinkPickerTargets._top]
    }

    /**
     * Content Type Aliases
    */
    enum ContentTypeAliases {
        Page,
        Image,
        Folder,
        File
    ...
    */
     ...
     * TreePicker Model
    */
    export interface ITreePickerModel {
        name: string;
        id: number;
        icon: string;
        trashed: boolean;
    ...
    */
    interface IMediaPickerOptions {
        ...
        onlyImages: boolean;
        /*callback function*/
        callback: (data: IMediaPickerModel) => void;
    }
    ...
    */
    interface ITreePickerOptions {
        ...
        multiPicker: boolean;
        /*callback function*/
        callback: (data: ITreePickerModel) => void;
    }
    ...
    interface IUmbracoRequestHelper {
        ...
        */
        resourcePromise<T>(httpPromise: ng.IPromise<T>, opts: string |
            ...
            { success: ng.IHttpPromiseCallback<T>; error: ng.IHttpPromiseCallback<umb.resources.IResourcePromise<T>> }): umb.resources.IResourcePromise<T> | Object;
    }
}
