...
declare module umbraco.resources{
     ...
     */
    export interface IResourcePromise<T> {
        errorMsg: string;
        data: T;
        status: number;
    }
...
interface IAuthResource{
         ...
         *
         */
        performLogin<T>(username: string, password: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        performLogout<T>(): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        getCurrentUser<T>(): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        isAuthenticated<T>(): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        getRemainingTimeoutSeconds<T>(): ng.IPromise<IResourcePromise<T>>;
}
...
interface IContentResource{
	/**
         ...
         *
         */
    sort<T>(...args: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    move<T>(...args: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    copy<T>(...args: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    unPublish<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    emptyRecycleBin<T>(): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    deleteById<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getById<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getByIds<T>(ids: number[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getScaffold<T>(parentId: number, alias: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getNiceUrl<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getChildren<T>(parentId: number, options?: { pageSize: number; pageNumber: number; filter: string; orderDirection: Direction; orderBy: OrderItemsBy }): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    checkPermission<T>(permission: string, id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    save<T>(content: IContentResource, isNew: boolean, files: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    publish<T>(content: IContentResource, isNew: boolean, files: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    sendToPublish<T>(content: IContentResource, isNew: boolean, files: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    publishById<T>(id: number): ng.IPromise<IResourcePromise<T>>;
...
interface IContentTypeResource{
         ...
         *
         */
    getAllowedTypes<T>(contentId: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getAllPropertyTypeAliases<T>(): ng.IPromise<IResourcePromise<T>>;
}
...
interface ICurrentUserResource{
         ...
         *
         */
    changePassword<T>(changePasswordArgs: any): ng.IPromise<IResourcePromise<T>>;
...
interface IDashboardResource{
         ...
         *
         */
    getDashboard<T>(section: string): ng.IPromise<IResourcePromise<T>>;
}
...
interface IDataTypeResource{
       /**
         ...
         *
         */
    getPreValues<T>(editorAlias: string, dataTypeId: number): ng.IPromise<IResourcePromise<T>>;
    ...
    getById<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        getScaffold<T>(): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        save<T>(dataType: Object, preValues: any[], isNew: boolean): ng.IPromise<IResourcePromise<T>>;
}
...
interface IEntityResource{
    ...
    /**
         ...
         *
         */
    getPath<T>(id: number, type: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getById<T>(id: number, type: string): ng.IPromise<IResourcePromise<T>>;

    getByQuery<T>(query: string, nodeContextId: number | string, type: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getByIds<T>(ids: number[], type: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getAll<T>(type: string, postFilter: string, postFilterParams: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getAncestors<T>(id: number, type: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getChildren<T>(id: number, type: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    search<T>(query: string, type: string, searchFrom: any, canceler: any): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    searchAll<T>(query: string, canceler: any): ng.IPromise<IResourcePromise<T>>;
}
...
interface ILogResource{
    /**
         ...
         *
         */
    getEntityLog<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getUserLog<T>(type: LogType, since: Date): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getLog<T>(type: LogType, since: Date): ng.IPromise<IResourcePromise<T>>;
}
...
interface IMediaResource{
    ...
    getScaffold<T>(parentId: number, alias: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        save<T>(media: Object, isNew: boolean, files: any[]): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
        addFolder<T>(name: string, parentId: number): ng.IPromise<IResourcePromise<T>>;
...
interface IMediaTypeResource{
    /**
         ...
         *
         */
    getAllowedTypes<T>(mediaId: number): ng.IPromise<IResourcePromise<T>>;
}
...
interface IMemberResource{
    ...
    /**
         ...
         *
         */
    getByKey<T>(key: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    deleteByKey<T>(key: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getScaffold<T>(alias: string): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    save<T>(member: Object, isNew: boolean, files: any[]): ng.IPromise<IResourcePromise<T>>;
...
interface IStylesheetResource{
     /**
         ...
         *
         */
    getAll<T>(): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getRules<T>(id: number): ng.IPromise<IResourcePromise<T>>;
         ...
         *
         */
    getRulesByName<T>(name: string): ng.IPromise<IResourcePromise<T>>;
...
*/
interface IContentResourceModel {
    urls: string[];
    name: string;
    contentTypeAlias: string; // ContentTypeAliases[ContentTypeAliases.Page]
}
